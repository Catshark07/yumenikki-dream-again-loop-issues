...
func handle_to_sprint() -> void:	if sentient.values.can_sprint: set_sub_state("sprint")
func handle_to_sneak() -> void: 	if sentient.values.can_sneak:  set_sub_state("sneak")
